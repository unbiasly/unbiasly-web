      ...
      <Container maxWidth='lg' disableGutters sx={{ mx: 'auto', my: { xs: '2.5rem', sm: '4rem' } }}>
        ...
        <Box sx={{ ml: '1.25rem' }}>
          <ul>
            ...
            <li>
              ...
              electronic device, named Unbiasly.
            </li>
            <li>
        ...
        <Box sx={{ ml: '1.25rem' }}>
          <ul>
            ...
            <li>
              ...
              Personal Data You provide allows you to access various features and functionalities available to
              registered users.
            </li>

            <li>
              <b>Performance of a contract:</b> This includes activities related to the creation, fulfillment, and
              management of purchase contracts for services you've bought or any other agreement with us via the
              Service.
            </li>
            <li>
        ...
        <Box sx={{ ml: '1.25rem' }}>
          <ul>
            ...
            <li>
              <b>For Business Transfers:</b> In the event of a merger, acquisition, or asset sale, your personal data
              may be transferred as part of the transaction. We will notify you in advance of such a transfer, and your
              data will remain subject to the same level of protection as outlined in this policy.
            </li>
            <li>
              <b>With Affiliates:</b> Your data may be shared with our affiliates, including our parent company and
              subsidiaries, joint venture partners, or entities under our control or common control. We ensure that
              these affiliates maintain the same level of data protection and adhere to this privacy policy.
            </li>
            <li>
              <b> With Business Partners:</b> We may share your information with trusted business partners to provide
              you with specific products, services, or promotional offers. Such sharing will be conducted with your
              consent or as otherwise permitted by applicable data protection laws.
            </li>
            <li>
        ...
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
          While we take diligent efforts to maintain a secure environment for your personal information, it's important
          to recognize that complete security is never absolute. We cannot guarantee that unintended disclosures of your
        ...
        <Box sx={{ ml: '1.25rem', my: '0.5rem' }}>
          <ul>
            <li>
              ...
              the content accessible through the App. We explicitly disclaim any liability for errors and omissions in
              the App's content.
            </li>
            <li>
              We do not provide any warranties of any kind, whether implied, expressed, or statutory. This includes but
              is not limited to warranties of non-infringement of third-party rights, title, merchantability, fitness
              for a particular purpose, and freedom from computer viruses concerning the content available through the
        ...
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C', my: '0.5rem' }}>
          We respect your rights and are committed to ensuring that you have control over your personal information. As
          a user, you have the following rights:
        </Typography>
        <Box sx={{ ml: '1.25rem' }}>
          <ul>
            <li>
