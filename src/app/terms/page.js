    ...
    <Box sx={{ width: '100vw', px: { xs: '1rem', sm: '2rem', md: '4rem' } }}>
      <Container maxWidth='lg' disableGutters sx={{ mx: 'auto', my: { xs: '2.5rem', sm: '4rem' } }}>
        ...
        <Typography variant='body1' align='justify' paragraph sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          ...
          agreement and an electronic record under the Information Technology Act, 2000 and rules thereunder as
          applicable and the amended provisions pertaining to electronic records in various statutes under applicable
          Indian laws. Please read these terms and conditions carefully before using Our Service.
        </Typography>
        ...
        <Box sx={{ ml: '1.25rem' }}>
          <ul>
            ...
            <li>
              <b>"AppStore Terms And Conditions"</b> means terms and conditions that apply to the use of AppStore
              platform and as available at{' '}
            ...
            <li>
              <b>"Sponsored Content"</b>means content distinct from other regular editorial content displayed on the
              App, in the form of audio, video, text and/or image media which supports a third party Person’s brand
              message or views that is readily identifiable upfront through distinct and distinguishable font, colour,
              display schemes and/or usage of disclaiming words other than those used for regular editorial content
              (such as
            ...
            <li>
              <b>"User” or “You” or “Your"</b> refers to a person who has accepted this Agreement in order to download
              and use the App.
            </li>
          </ul>
        </Box>
        ...
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
          Your access to and use of the Service are contingent upon your acceptance of and compliance with these Terms
          and Conditions. These Terms and Conditions are applicable to all visitors, users, and others who access or use
          the Service.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          By accessing or using the Service, you signify your agreement to be bound by these Terms and Conditions. If
          you disagree with any part of these Terms and Conditions, you may not access the Service.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
        ...
        <ol style={{ counterReset: 'list' }}>
          <OrderedList index={1}>
            ...
            enter into a binding contract with Us through your use of the App. You represent that you are over the age
            of 18. The Company does not permit those under 18 to use the Service.
          </OrderedList>
          <OrderedList index={2}>
            You represent a legal entity that lawfully exists and possesses all the necessary authorizations, permits,
            and approvals to enter into this Agreement and create a binding contract.
          </OrderedList>
        ...
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
          Your access to and use of the Service is also contingent upon your acceptance of and compliance with the
          Privacy Policy of the Company. Our Privacy Policy describes our policies and procedures regarding the
          collection, use, and disclosure of your personal information when you use the Application or the Website. It
          also informs you about your privacy rights and how the law protects you. Please read our Privacy Policy
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          ...
          information. Failure to do so may result in a breach of the Terms, and we reserve the right to take
          appropriate actions, which may include the termination of your account on our service at our discretion.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          Furthermore, you agree not to disclose your password to any third party, as this is crucial for maintaining
          the security of your account. It's important to note that our company will never solicit your password through
          unsolicited communications.
        </Typography>

        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
          In the event that you become aware of a breach of security or unauthorized use of your account, it is your
          responsibility to notify us immediately. This ensures that we can take prompt action to secure your account
        ...
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
          Any content you create with the App grants us a limited, non-exclusive, transferable, and assignable license
          to use it in accordance with our terms and policies, including the content regulation policy and any
          agreements between you and us. This license may also include our right to sublicense.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
        ...
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
          ...
          party. We do not license such third-party content to you, and your usage is subject to the terms and
          conditions set forth by the respective third party.
        </Typography>
        ...
        <Box sx={{ ml: '1.25rem' }}>
          <ul>
            ...
            <li>
              ...
              It's important to note that the App does not store, display, or transmit any content owned by third
              parties on its servers unless we have a valid license to do so or are otherwise authorized by applicable
              laws.
            </li>
            <li>
              <b>Leaving the App: </b>
              When Users read a summary and decide to access the source of that summary by following an external link,
              they should be aware that they are leaving the App. In such cases, the App and the Company do not assume
              any responsibility, liability, or obligation for any data breaches or damages that may occur as a result
              of using these external sources on third-party websites.
            </li>

            <li>
              <b>App as an Intermediary: </b>
              Users must recognize and accept that the App acts solely as an intermediary. The App does not
              independently generate or provide any content. Therefore, we are not accountable or liable for the
              accuracy of the content or the quality of the summaries that users may access through the App.
            </li>
        ...
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
          ...
          parties on the Service, You agree to use the Service at your own risk. You understand that by using the
          Service You may be exposed to content that You may find offensive, indecent, incorrect or objectionable, and
          You agree that under no circumstances will the Company be liable in any way for any content, including any
        ...
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
          In the event of issues affecting the integrity of Content backups, the Company is committed to providing
          support and investigating any known or discovered problems. However, it's crucial to acknowledge that the
          Company holds no liability concerning the integrity of Content or the successful restoration of Content to a
          usable state.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
        ...
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
          ...
          is being used on the Service in a manner that constitutes copyright infringement, please follow the steps
          below.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          You hereby assign all rights, title, and interest in any Feedback You provide to the Company. In the event
          that such assignment is not legally effective, You agree to grant the Company a non-exclusive, perpetual,
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          Our Service may include links to websites or services operated by third parties that are not owned or
        ...
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
          ...
          not be held responsible or liable, either directly or indirectly, for any damage or loss caused or alleged to
          be caused by or in connection with the use of or reliance on any such content, goods, or services available on
          or through any such third-party websites or services.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          We strongly recommend that You carefully review the terms and conditions, as well as the privacy policies of
          any third-party websites or services You choose to visit.
        </Typography>
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          The Service is provided to You "AS IS" and "AS AVAILABLE," with all faults and defects, without warranty of
          any kind. To the maximum extent permitted under Indian law, the Company, on its own behalf and on behalf of
          ...
          Additionally, it disclaims warranties that may arise out of course of dealing, course of performance, usage,
          or trade practice.
        </Typography>
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
        ...
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
          Further, neither the Company nor any of the company's providers make any representation or warranty of any
        ...
        <Typography variant='body1' align='justify' sx={{ mt: '0.5rem', color: '#7C7C7C' }}>
          ...
          statutory rights of a consumer. In such cases, the exclusions and limitations set forth in this section shall
          be applied to the greatest extent enforceable under Indian law.
        </Typography>
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          ...
          and Conditions or your use of the services shall be governed by and construed in accordance with the laws of
          the Republic of India, including but not limited to:
        </Typography>
        <Box sx={{ ml: '1.25rem' }}>
          <ul>
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          ...
          access our services from a location outside India, you are responsible for compliance with all applicable
          local laws.
        </Typography>
        ...
        <Typography variant='body1' align='justify' sx={{ my: '0.5rem', color: '#7C7C7C' }}>
          ...
          interpreted to accomplish the objectives of that provision to the greatest extent possible under applicable
        ...
        <Typography variant='body1' align='justify' sx={{ color: '#7C7C7C' }}>
          By continuing to access or use Our Service after these revisions become effective, You agree to be bound by
          the updated terms. If You do not agree to the new terms, in whole or in part, please discontinue using the
