...
// }, [autoScroll]);
    ...
    >
      ...
      <div className="flex space-x-4">
        {member.social.linkedin && (
          <FaLinkedin className="text-white text-xl hover:text-blue-500 transition-colors" />
        )}
        {member.social.twitter && (
          <FaTwitter className="text-white text-xl hover:text-blue-400 transition-colors" />
        )}
        {member.social.github && (
          <FaGithub className="text-white text-xl hover:text-gray-400 transition-colors" />
        )}
      </div>
    </div>
  ));
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-6">
              {member.social.linkedin && (
                <FaLinkedin className="text-white text-2xl hover:text-blue-500 transition-colors cursor-pointer" />
              )}
              {member.social.twitter && (
                <FaTwitter className="text-white text-2xl hover:text-blue-400 transition-colors cursor-pointer" />
              )}
              {member.social.github && (
                <FaGithub className="text-white text-2xl hover:text-gray-400 transition-colors cursor-pointer" />
              )}
            </div>
          </div>
        </div>
  ...
  return (
    <div className=" bg-black text-white ">
      ...
      <div
        className="flex overflow-x-auto space-x-6 pb-8 px-4"
