...
export const KeyFeatures: React.FC<KeyFeaturesProps> = ({ features, ...props }) => {
    ...
    return (
        <div {...props} className="relative flex items-center justify-center w-full">
            <button
                    ...
                    {features.map((feature, index) => (
                        <div
                            ...
                            <div className="flex-1 mt-5 lg:my-auto lg:ml-8 max-lg:text-center">
                                <div className="text-zinc-500 mb-2 text-2xl lg:text-6xl">{String(index + 1).padStart(2, "0")}</div>
