    ...
    return (
        <div {...props} className="text-white mt-5 lg:mt-6 relative flex items-center justify-center w-full">
            <button
                ...
                className=" top-1/2 -left-8 -translate-y-1/2 transform z-10"
                aria-label="Previous feature">
                <ChevronLeft className="w-12 h-12 text-black/60 hover:text-black transition-colors" />
            </button>
                    ...
                    {features.map((feature, index) => (
                        <div
                            ...
                            <div className="flex-1 mt-5 lg:my-auto lg:ml-8 max-lg:text-center">
                                ...
                                <p className="max-w-[800px] text-xs leading-relaxed lg:text-xl lg:leading-relaxed mt-1 lg:mt-3 text-black">
                                    {feature.description}
                                </p>
                            </div>
            ...
            <button
                onClick={nextSlide}
                className=" top-1/2 -right-8 -translate-y-1/2 transform z-10"
                aria-label="Next feature">
                <ChevronRight className="w-12 h-12 text-black/60 hover:text-black transition-colors" />
            </button>
        </div>
    )
}
